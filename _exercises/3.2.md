...
description: Introducing Tkinter for simple user interfaces.
---
...
We also need to call `grid()` on each label in order to register it with the `grid` geometry manager and place it on the interface.

>Other geometry managers are available, but we will use `grid` to position all our widgets.

At the end of our script, we can now actually create an instance of our application and start the tkinter main loop like this.
...
![A basic application]({{ "assets/img/tkinter/step_00.png" | relative_url }})
...
![Add some padding and a title]({{"assets/img/tkinter/step_01.png" | relative_url}})
...
![Buttons are easy]({{"assets/img/tkinter/step_02.png" | relative_url}})
...
![Something a bit more useful?]({{"assets/img/tkinter/step_03.png" | relative_url }})
...
We are going to build a simple shopping list application.
...
![Disorganised widgets]({{"assets/img/tkinter/step_04.png" | relative_url }})
...
<table style="text-align: center; min-width: 400px">
    <tr><th>row/col</th><th>1</th><th>2</th></tr>
    <tr>
        <th>1</th><td colspan=2>Label</td>
    </tr>
    <tr>
        <th>2</th>
        <td>Entry</td>
...
![Nicely positioned widgets]({{"assets/img/tkinter/step_05.png" | relative_url }})
...
![Beautiful]({{"assets/img/tkinter/step_06.png" | relative_url }})
...
![Adding items]({{"assets/img/tkinter/step_07.png" | relative_url }})
