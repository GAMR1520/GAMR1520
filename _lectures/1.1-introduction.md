...
<figure class="row short">
    <img src="{{"assets/img/results/phase test.png" | relative_url }}" alt="phase test">
    <img src="{{"assets/img/results/python assignment.png" | relative_url }}" alt="python assignment">
    <img src="{{"assets/img/results/javascript assignment.png" | relative_url }}" alt="javascript assignment">
</figure>
...
- [![flask](https://flask.palletsprojects.com/en/2.2.x/_images/flask-logo.png)](https://palletsprojects.com/p/flask/)
{: .libraries}
