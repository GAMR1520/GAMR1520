...
<figure>
    ...
    subgraph objects ["pyObjects, not bytes"]
        100000000
        100000001
    end
...
The `def` keyword allows us to define a function with a list of arguments in parentheses.
...
> Try to keep your functions small, like this.
> A function should usually do just one thing.
